...
#include "compressor/isal/IsalCompressor.h"
#include "common/ceph_argparse.h"
#include "global/global_context.h"
#include "common/config.h"

TEST(IsalCompressor, compress_decompress)
{
  IsalCompressor sp;
  EXPECT_STREQ(sp.get_method_name(), "isa-l");
...
TEST(IsalCompressor, compress_decompress_chunk)
{
  IsalCompressor sp;
  EXPECT_STREQ(sp.get_method_name(), "isa-l");
  char* test = "This is test text";
 ...
 *   make unittest_compression_isal && 
 *   valgrind --tool=memcheck \
 *      ./unittest_compression_isal \
